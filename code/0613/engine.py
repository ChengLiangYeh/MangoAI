...
def train_model(model, dataloaders, criterion, optimizer, device,  lr_rate ,num_epochs=25, is_inception=False,):
    since = time.time()
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            # Iterate over data
            for inputs, labels,f_input in dataloaders[phase]:
